...
const getApiBaseUrl = () => {
    ...
    if (isLocalOrNetwork) {
        // No XAMPP ou Nginx manual, o suporte a PATH_INFO (index.php/rota) pode estar desativado.
        // Usar ?route= é a forma mais compatível de garantir que as rotas funcionem em qualquer servidor.
        return url.origin + projectRoot + '/backend/public/index.php?route=';
    }
